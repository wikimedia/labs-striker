    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "repository",
                    models.CharField(null=True, max_length=2047, blank=True),
                ),
                ...
                (
                    ...
                    models.ManyToManyField(
                        to=settings.AUTH_USER_MODEL, related_name="_toolinfo_authors_+"
                    ),
                ),
                (
                    "license",
                    models.ForeignKey(
                        to="tools.SoftwareLicense", on_delete=models.CASCADE
                    ),
                ),

...
from striker.tools.views import membership, project, repo, tool, toolinfo
...
urlpatterns = [
                ...
                path(
                    ...
                    include(
                        [
                            ...
                            path(
                                "id/<slug:project>", project.view, name="project_view"
                            ),
                        ]
                    ),
                ),
    ...
    path(
        ...
        include(
            [
                ...
                path(
                    "status/<int:app_id>", membership.status, name="membership_status"
                ),
            ]
        ),
    ),
    path(
        "tags/autocomplete/",
        toolinfo.TagAutocomplete.as_view(),
        name="tags_autocomplete",
    ),
    path("toolinfo/v1/toolinfo.json", toolinfo.json_v1, name="toolinfo"),
    path("toolinfo/v1.2/toolinfo.json", toolinfo.json_v1_2, name="toolinfo-1.2"),
                    ...
                    path(
                        ...
                        include(
                            [
                                path(
                                    "author",
                                    toolinfo.AuthorAutocomplete.as_view(),
                                    name="author",
                                ),
                                path(
                                    "maintainer",
                                    tool.MaintainerAutocomplete.as_view(),
                                    name="maintainer",
                                ),
                                path(
                                    "tooluser",
                                    tool.ToolUserAutocomplete.as_view(),
                                    name="tooluser",
                                ),
                            ]
                        ),

...
if DATABASES["default"]["ENGINE"] in ["django.db.backends.mysql", "striker.db"]:
...
SECURE_SSL_HOST = env.str("SSL_CANONICAL_HOST", default="toolsadmin.wikimedia.org")
...
AUTH_LDAP_PASSWORD_RESET_URL = env.str(
    "AUTH_LDAP_PASSWORD_RESET_URL", "https://idm.wikimedia.org/wikimedia/password/"
)


AUTHENTICATION_BACKENDS = ("striker.labsauth.backends.RateLimitedLDAPBackend",)
...
OAUTH_MWURL = env.str("OAUTH_MWURL", default="https://meta.wikimedia.org/w/index.php")
...
# == Wikitech settings ==
WIKITECH_URL = env.str("WIKITECH_URL", default="https://wikitech.wikimedia.org")
...
OPENSTACK_URL = env.str(
    "OPENSTACK_URL", default="https://openstack.eqiad1.wikimediacloud.org:25000/v3"
)

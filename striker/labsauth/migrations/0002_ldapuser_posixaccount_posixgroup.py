    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uid', ldapdb.models.fields.CharField(primary_key=True, serialize=False, db_column='uid', max_length=200)),
                ('cn', ldapdb.models.fields.CharField(unique=True, db_column='cn', max_length=200)),
                ('uid_number', ldapdb.models.fields.IntegerField(unique=True, db_column='uidNumber')),
                ('gid_number', ldapdb.models.fields.IntegerField(db_column='gidNumber')),
                ('home_dir', ldapdb.models.fields.CharField(db_column='homeDirectory', max_length=200)),
                ('login_shell', ldapdb.models.fields.CharField(db_column='loginShell', max_length=200)),
                ('password', ldapdb.models.fields.CharField(db_column='userPassword', max_length=200)),
                ('sn', ldapdb.models.fields.CharField(unique=True, db_column='sn', max_length=200)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('dn', models.CharField(max_length=200)),
                ('cn', ldapdb.models.fields.CharField(primary_key=True, serialize=False, db_column='cn', max_length=200)),
